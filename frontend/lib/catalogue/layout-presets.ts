...
export const contentOptions:Record<PageSpec["type"],{key:string;label:string;defaultSize:number;defaultWeight:number}[]>={
  ...
  about:[{key:"pageTitle",label:"About title",defaultSize:72,defaultWeight:700},{key:"brandTitle",label:"Brand title",defaultSize:28,defaultWeight:700},{key:"description",label:"Description",defaultSize:24,defaultWeight:400}],
  "collection-cover":[{key:"collectionLabel",label:"Collection label",defaultSize:36,defaultWeight:400},{key:"collectionTitle",label:"Collection name",defaultSize:120,defaultWeight:800},{key:"productId",label:"Product ID",defaultSize:9,defaultWeight:500},{key:"productName",label:"Product name",defaultSize:13,defaultWeight:600},{key:"price",label:"Price",defaultSize:12,defaultWeight:600},{key:"dimensions",label:"Dimensions",defaultSize:9,defaultWeight:400}],
  "product-grid":[{key:"productId",label:"Product ID",defaultSize:9,defaultWeight:500},{key:"productName",label:"Product name",defaultSize:13,defaultWeight:600},{key:"price",label:"Price",defaultSize:12,defaultWeight:600},{key:"dimensions",label:"Dimensions",defaultSize:9,defaultWeight:400}],
  highlight:[{key:"productId",label:"Product ID",defaultSize:36,defaultWeight:400},{key:"productName",label:"Product name",defaultSize:68,defaultWeight:700},{key:"price",label:"Price",defaultSize:68,defaultWeight:700},{key:"dimensions",label:"Dimensions",defaultSize:30,defaultWeight:400}],
...
export const aboutDefaultStyles:Record<string,ContentStyle>={pageTitle:{...defaultContentStyle,fontSize:72,fontWeight:700},brandTitle:{...defaultContentStyle,fontSize:28,fontWeight:700,paddingTop:30},description:{...defaultContentStyle,fontSize:24,fontWeight:400,paddingTop:18}};
